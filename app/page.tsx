...
export default function Dashboard() {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen text-black space-y-6">
      ...
      {xpPop && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 text-3xl font-bold text-green-600 animate-bounce pointer-events-none">
          {xpPop}
        </div>
      )}
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-white rounded shadow">
          ...
          {Number(avgUnits) >= targetUnits ? (
            <p className="text-green-600 font-semibold">🔥 Target Met</p>
          ) : (
